    ...
    // GLOBAL SCOPE TO SEE SEE FRIENDS IF FUNCTION SEE READY HAS BEEN CLICK
    var SEEFRIENDS;
    var TEXTVALUE;
    var SHARETEXT;
    var IMGLIST;
    ...
    function JUSTUPLOAD(dialog) {
        setTimeout(() => {
            fn.load('JUSTUPLOAD.html');
            HIDEADDPOSTINTIMELINE(dialog);
        }, 0000);
        setTimeout(() => {
            document.getElementById('JUSTBACK').innerHTML = "<ons-back-button style=\"color: #fff\" onclick=\"SEETIMELINEREADY(), SEEABOUTINTIMELINE(), fn.load('see-profile.html'), DEFINELOGOUT()\">BACK</ons-back-button>";
        ...
        setTimeout(() => {
            ...
            SHARETEXT.addEventListener('click', SHARETOTIMELINE);
        }, 1001);
    }

    function IMAGEUPLOAD(dialog) {
        setTimeout(() => {
            fn.load('IMAGEUPLOAD.html');
            HIDEADDPOSTINTIMELINE(dialog);
        }, 0000);
        setTimeout(() => {
            document.getElementById('IMAGEBACK').innerHTML = "<ons-back-button style=\"color: #fff\" onclick=\"SEETIMELINEREADY(), SEEABOUTINTIMELINE(), fn.load('see-profile.html'), DEFINELOGOUT()\">BACK</ons-back-button>";
    ...
    function VIDEOUPLOAD(dialog) {
        setTimeout(() => {
            fn.load('VIDEOUPLOAD.html');
            HIDEADDPOSTINTIMELINE(dialog);
        }, 0000);
        setTimeout(() => {
            document.getElementById('VIDEOBACK').innerHTML = "<ons-back-button style=\"color: #fff\" onclick=\"SEETIMELINEREADY(), SEEABOUTINTIMELINE(), fn.load('see-profile.html'), DEFINELOGOUT()\">BACK</ons-back-button>";
    ...
    function AUDIOUPLOAD(dialog) {
        setTimeout(() => {
            fn.load('AUDIOUPLOAD.html');
            HIDEADDPOSTINTIMELINE(dialog);
        }, 0000);
        setTimeout(() => {
            document.getElementById('AUDIOBACK').innerHTML = "<ons-back-button style=\"color: #fff\" onclick=\"SEETIMELINEREADY(), SEEABOUTINTIMELINE(), fn.load('see-profile.html'), DEFINELOGOUT()\">BACK</ons-back-button>";
    ...
    function DOCUMENTUPLOAD(dialog) {
        setTimeout(() => {
            fn.load('DOCUMENTUPLOAD.html');
            HIDEADDPOSTINTIMELINE(dialog);
        }, 0000);
        setTimeout(() => {
            document.getElementById('DOCUMENTBACK').innerHTML = "<ons-back-button style=\"color: #fff\" onclick=\"SEETIMELINEREADY(), SEEABOUTINTIMELINE(), fn.load('see-profile.html'), DEFINELOGOUT()\">BACK</ons-back-button>";
    ...
    function ZIPUPLOAD(dialog) {
        setTimeout(() => {
            fn.load('ZIPUPLOAD.html');
            HIDEADDPOSTINTIMELINE(dialog);
        }, 0000);
        setTimeout(() => {
            document.getElementById('ZIPBACK').innerHTML = "<ons-back-button style=\"color: #fff\" onclick=\"SEETIMELINEREADY(), SEEABOUTINTIMELINE(), fn.load('see-profile.html'), DEFINELOGOUT()\">BACK</ons-back-button>";
    ...
    function ADSUPLOAD(dialog) {
        setTimeout(() => {
            fn.load('ADSUPLOAD.html');
            HIDEADDPOSTINTIMELINE(dialog);
        }, 0000);
        setTimeout(() => {
            document.getElementById('ADSBACK').innerHTML = "<ons-back-button style=\"color: #fff\" onclick=\"SEETIMELINEREADY(), SEEABOUTINTIMELINE(), fn.load('see-profile.html'), DEFINELOGOUT()\">BACK</ons-back-button>";
            ...
            document.getElementById('ADSSELECT').innerHTML = "<img onclick=\"IMAGESELECTED()\" src=\"https://img.icons8.com/color/158/000000/xlarge-icons.png\"><img onclick=\"VIDEOSELECTED()\" src=\"https://img.icons8.com/color/158/000000/tv-show.png\">";
...
function JOBUPLOAD(dialog) {
    setTimeout(() => {
        fn.load('JOBUPLOAD.html');
        HIDEADDPOSTINTIMELINE(dialog);
    }, 0000);
    setTimeout(() => {
        document.getElementById('JOBBACK').innerHTML = "<ons-back-button style=\"color: #fff\" onclick=\"SEETIMELINEREADY(), SEEABOUTINTIMELINE(), fn.load('see-profile.html'), DEFINELOGOUT()\">BACK</ons-back-button>";
...
function HOWTOUPLOAD(dialog) {
    setTimeout(() => {
        fn.load('HOWTOUPLOAD.html');
        HIDEADDPOSTINTIMELINE(dialog);
    }, 0000);
    setTimeout(() => {
        document.getElementById('HOWTOBACK').innerHTML = "<ons-back-button style=\"color: #fff\" onclick=\"SEETIMELINEREADY(), SEEABOUTINTIMELINE(), fn.load('see-profile.html'), DEFINELOGOUT()\">BACK</ons-back-button>";
        ...
        var b = document.createElement('ons-button');
        b.setAttribute('onclick', 'SELECTED7()');
        b.setAttribute('modifier', 'noshadow');
        b.setAttribute('style', 'width:100%;background-color:#3498DB;color:#fff');
        ...
        // IMAGE
        document.getElementById("HOWTOIMG1").innerHTML = '<img style="width:100%;height:100%" onclick="SELECTED1()" id="SL1" src="https://img.icons8.com/color/158/000000/add-image.png">';
        document.getElementById("HOWTOIMG2").innerHTML = '<img style="width:100%;height:100%" onclick="SELECTED2()" id="SL2" src="https://img.icons8.com/color/158/000000/add-image.png">';
        document.getElementById("HOWTOIMG3").innerHTML = '<img style="width:100%;height:100%" onclick="SELECTED3()" id="SL3" src="https://img.icons8.com/color/158/000000/add-image.png">';
        document.getElementById("HOWTOIMG4").innerHTML = '<img style="width:100%;height:100%" onclick="SELECTED4()" id="SL4" src="https://img.icons8.com/color/158/000000/add-image.png">';
        document.getElementById("HOWTOIMG5").innerHTML = '<img style="width:100%;height:100%" onclick="SELECTED5()" id="SL5" src="https://img.icons8.com/color/158/000000/add-image.png">';
        document.getElementById("HOWTOIMG6").innerHTML = '<img style="width:100%;height:100%" onclick="SELECTED6()" id="SL6" src="https://img.icons8.com/color/158/000000/add-image.png">';
    }, 1000);
    setTimeout(() => {
        TEXTVALUE = document.getElementById('TEXTVALUE');
        SHARETEXT = document.getElementById('SHARETEXT');
...
function DONATEUPLOAD(dialog) {
    setTimeout(() => {
        fn.load('DONATEUPLOAD.html');
        HIDEADDPOSTINTIMELINE(dialog);
    }, 0000);
    setTimeout(() => {
        document.getElementById('DONATEBACK').innerHTML = "<ons-back-button style=\"color: #fff\" onclick=\"SEETIMELINEREADY(), SEEABOUTINTIMELINE(), fn.load('see-profile.html'), DEFINELOGOUT()\">BACK</ons-back-button>";
    ...
    function EVENTUPLOAD(dialog) {
        setTimeout(() => {
            fn.load("EVENTUPLOAD.html");
            HIDEADDPOSTINTIMELINE(dialog);
        }, 0000);
        setTimeout(() => {
            document.getElementById('EVENTBACK').innerHTML = "<ons-back-button style=\"color: #fff\" onclick=\"SEETIMELINEREADY(), SEEABOUTINTIMELINE(), fn.load('see-profile.html'), DEFINELOGOUT()\">BACK</ons-back-button>";
    ...
    function MARKETUPLOAD(dialog) {
        setTimeout(() => {
            fn.load("MARKETUPLOAD.html");
            HIDEADDPOSTINTIMELINE(dialog);
        }, 0000);
        setTimeout(() => {
            document.getElementById('MARKETBACK').innerHTML = "<ons-back-button style=\"color: #fff\" onclick=\"SEETIMELINEREADY(), SEEABOUTINTIMELINE(), fn.load('see-profile.html'), DEFINELOGOUT()\">BACK</ons-back-button>";
    ...
    var SHOWADDPOSTINTIMELINE = function () {
        var dialog = document.getElementById('ADDPOSTINTIMELINE-DIALOG');

        if (dialog) {
            dialog.show();
        } else {
            ons.createElement('ADDPOSTINTIMELINE.html', {
                    append: true
                })
    ...
    var HIDEADDPOSTINTIMELINE = function (id) {
        document
            .getElementById(id)
            .hide();
    };
    ...
    function SEETIMELINEREADY() {
        setTimeout(() => {
            console.log('SEE TIMELINE READY IS USING!');
            SHAREDONTIMELINE = document.getElementById('SHAREDPOSTSINTIMELINE');
            SEEFRIENDS = document.getElementById('SEEYOURFRIENDS');
        }, 0000);
        setTimeout(() => {
            USERDATABASE.child(firebase.auth().currentUser.uid)
                .child('User/About/Authentic').on('child_added',
                    function (myname) {
                        USERDATABASE.child(firebase.auth().currentUser.uid)
                            .child('User/Post/Timeline').child(myname.key)
                        ...
                        USERDATABASE.child(firebase.auth().currentUser.uid)
                            .child('User/People/' + myname.key + '/Friends')
                            .on('value', function (check) {
                                var a = check.exists();
                                if (a) {
                                    USERDATABASE.child(firebase.auth().currentUser.uid)
                                        .child('User/People/' + myname.key + '/Friends').on('child_added', function (checked) {
                                            var span = document.createElement('span');
                                            var item = document.createElement('span');
                                            item.innerHTML = checked.val();
                                            SEEFRIENDS.appendChild(span);
                                            span.appendChild(item);
                                        })
                                }
                            })
